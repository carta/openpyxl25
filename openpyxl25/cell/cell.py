...
from openpyxl25.utils.datetime  import (
    to_excel,
    time_to_days,
    timedelta_to_days,
    from_excel
...
from openpyxl25.utils.units import points_to_pixels
from openpyxl25.utils import (
    get_column_letter,
    column_index_from_string,
)
from openpyxl25.styles import numbers, is_date_format
...
class Cell(StyleableObject):
    ...
    def offset(self, row=0, column=0):
        ...
        :rtype: :class:`openpyxl25.cell.Cell`
        """
    ...
    def comment(self):
        """ Returns the comment associated with this cell
            ...
            :rtype: :class:`openpyxl25.comments.Comment`
        """
