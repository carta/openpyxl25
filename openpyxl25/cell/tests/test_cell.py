...
from openpyxl25.cell.cell import ERROR_CODES
...
def test_illegal_characters(dummy_cell):
    from openpyxl25.utils.exceptions import IllegalCharacterError
    from openpyxl25.compat import range
...
def test_time_regex(value, expected):
    from openpyxl25.cell.cell import TIME_REGEX
...
def test_border(DummyWorksheet, Cell):
    from openpyxl25.styles import Border
    border = Border()
    ws = DummyWorksheet
...
def test_alignment(DummyWorksheet, Cell):
    from openpyxl25.styles import Alignment
...
def test_protection(DummyWorksheet, Cell):
    from openpyxl25.styles import Protection
