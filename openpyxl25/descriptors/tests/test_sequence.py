...
from openpyxl25.descriptors.base import Integer, Alias
...
@pytest.fixture
def MultiSequence():
    from openpyxl25.descriptors.sequence import MultiSequence
    return MultiSequence


@pytest.fixture
def MultiSequencePart():
    from openpyxl25.descriptors.sequence import MultiSequencePart
