...
class TestSerialisable:
    ...
    def test_str(self, Immutable):
        d = Immutable()
        assert str(d) == """<openpyxl25.descriptors.tests.test_serialisable.Immutable object>
Parameters:
value=None"""

        d2 = Immutable("hello")
        assert str(d2) == """<openpyxl25.descriptors.tests.test_serialisable.Immutable object>
Parameters:
value='hello'"""
