...
@pytest.fixture
def CacheField():
    from openpyxl25.pivot.cache import CacheField
    return CacheField
...
@pytest.fixture
def SharedItems():
    from openpyxl25.pivot.cache import SharedItems
    return SharedItems
...
@pytest.fixture
def WorksheetSource():
    from openpyxl25.pivot.cache import WorksheetSource
...
@pytest.fixture
def CacheSource():
    from openpyxl25.pivot.cache import CacheSource
    return CacheSource
...
@pytest.fixture
def CacheDefinition():
    from openpyxl25.pivot.cache import CacheDefinition
