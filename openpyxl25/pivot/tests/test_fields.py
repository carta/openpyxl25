...
@pytest.fixture
def Error():
    from openpyxl25.pivot.record import Error
    return Error
...
@pytest.fixture
def Boolean():
    from openpyxl25.pivot.record import Boolean
    return Boolean
...
@pytest.fixture
def Missing():
    from openpyxl25.pivot.record import Missing
    return Missing
...
@pytest.fixture
def Number():
    from openpyxl25.pivot.record import Number
    return Number
...
@pytest.fixture
def Text():
    from openpyxl25.pivot.record import Text
    return Text
...
@pytest.fixture
def Index():
    from openpyxl25.pivot.record import Index
    return Index
...
@pytest.fixture
def DateTimeField():
    from openpyxl25.pivot.record import DateTimeField
