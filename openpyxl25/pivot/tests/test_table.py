...
from openpyxl25.tests.schema import sheet_schema



@pytest.fixture
def PivotField():
    from openpyxl25.pivot.table import PivotField
    return PivotField
...
@pytest.fixture
def FieldItem():
    from openpyxl25.pivot.table import FieldItem
    return FieldItem
...
@pytest.fixture
def RowColItem():
    from openpyxl25.pivot.table import RowColItem
    return RowColItem
...
@pytest.fixture
def DataField():
    from openpyxl25.pivot.table import DataField
    return DataField
...
@pytest.fixture
def Location():
    from openpyxl25.pivot.table import Location
    return Location
...
@pytest.fixture
def PivotTableStyle():
    from openpyxl25.pivot.table import PivotTableStyle
...
@pytest.fixture
def PageField():
    from openpyxl25.pivot.table import PageField
    return PageField
...
@pytest.fixture
def Reference():
    from openpyxl25.pivot.table import Reference
    return Reference
...
@pytest.fixture
def PivotArea():
    from openpyxl25.pivot.table import PivotArea
    return PivotArea
...
@pytest.fixture
def ChartFormat():
    from openpyxl25.pivot.table import ChartFormat
    return ChartFormat
