...
from openpyxl25.styles.styleable import StyleArray
...
from openpyxl25.cell.read_only import EMPTY_CELL
...
def test_read_dimension(datadir, filename, expected):
    from openpyxl25.worksheet.read_only import read_dimension
