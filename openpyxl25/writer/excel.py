...
# package imports
from openpyxl25.utils.exceptions import InvalidFileException
...
from openpyxl25.xml.functions import tostring, fromstring, Element
from openpyxl25.packaging.manifest import Manifest
from openpyxl25.packaging.relationship import (
    get_rels_path,
    RelationshipList,
    Relationship,
)
...
from openpyxl25.writer.theme import write_theme
...
def save_workbook(workbook, filename,):
    ...
    :type workbook: :class:`openpyxl25.workbook.Workbook`
